...
export type Ouvrage = { id:string; titre:string; sous_titre:string|null; isbn:string|null; editeur:string|null; edition:string|null; annee_publication:number|null; description:string|null; matiere_id:string; niveau_scolaire_id:string|null; type_ouvrage_id:string; au_programme_scolaire:boolean; cle_image_couverture:string|null; est_actif:boolean; date_creation:string; date_modification:string; nombre_exemplaires?:number; nombre_disponibles?:number; nombre_empruntes?:number }
