...
export const validationsRessources = {
  ...
  etablissements: z.object({ code: texte(30).transform((v) => v.toUpperCase()), nom: texte(255), type_etablissement: z.enum(["PERISCOLAIRE","PRIMAIRE","SECONDAIRE"]), statut: z.enum(["INITIALISATION","ACTIF","INACTIF","DESACTIVE"]).optional() }),
  types_ouvrages: z.object({ code: texte(50).transform((v) => v.toUpperCase()), nom: texte(150), description: optionnel(500), est_actif: z.boolean().optional() }),
