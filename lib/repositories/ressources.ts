...
export const configurations: Record<NomRessource, Configuration> = {
  ...
  etablissements: { recherche: ["code","nom","type_etablissement"], tri: ["nom","code","type_etablissement","statut"], filtres: ["type_etablissement","statut","est_actif"] },
  types_ouvrages: { recherche: ["code","nom","description"], tri: ["nom","code"], filtres: ["est_actif"] },
